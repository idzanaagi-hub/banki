...
export class AutoPage {
    ...
    constructor(page: Page) {
        ...
        this.autoDocumentIssueDateField = page.locator('[name="autoDocumentIssueDate"]');
    ...
    async fillAutoPage(testData: { autoBrand: string; autoModel: string; autoYear: string; number: string; autoPower: string; vinNumber: string; autoDocumentsNumber: string; autoDocumentIssueDate: string; }) {
